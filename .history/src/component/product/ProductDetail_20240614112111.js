            ...
            {[...Array(5)].map((_, index) => {
              ...
              return (
                <FaStar
                  key={index}
                  className="star"
                  color={onClick <= rating ? "#ffc107" : "#e4e5e9"} // Đổi màu sao đã chọn thành màu vàng
                  onClick={() => handleRatingChange(onClick)} // Gọi hàm handleRatingChange khi người dùng click vào sao
                />
              );
            })}
          </div>
