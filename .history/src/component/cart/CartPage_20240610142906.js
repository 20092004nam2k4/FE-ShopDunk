      ...
      <div className="tong">
        ...
        <div className="deals">
            <div className="coupon-box">
              ...
              <input className="giamgia" value={"mã giảm giá"}/>
                <button type="submit" name="applydiscountcouponcode" id="applydiscountcouponcode"className="button-2 apply-discount-coupon-code-button">
                  Áp dụng
                </button>
              </div>
