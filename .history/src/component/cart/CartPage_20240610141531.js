      ...
      <div className="tong">
        ...
        <div className="deals">
            <div className="coupon-box">
              ...
              <input name="discountcouponcode" id="discountcouponcode" placeholder="Mã giảm giá" type="text" class="discount-coupon-code" aria-label="Nhập mã phiếu giảm giá"> <button type="submit" name="applydiscountcouponcode" id="applydiscountcouponcode" class="button-2 apply-discount-coupon-code-button">Áp dụng</button></div>
              </div>
          ...
          <h6>Giao tận nơi</h6>
            ...
            <div class="edit-address">
              <div class="delivery-method">
                <input type="radio" id="receive-store" name="receive-method" value="store"></input>Nhận tại cửa hàng
                <input type="radio" id="receive-delivery" name="receive-method" value="delivery"></input>Giao tận nơi
              </div>
              <div class="half-inputs">
