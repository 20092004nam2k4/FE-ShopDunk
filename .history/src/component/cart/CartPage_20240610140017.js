          ...
          <h6>Giao tận nơi</h6>
            ...
            <div class="edit-address">
              <div class="delivery-method">
                <input type="radio" id="receive-store" name="receive-method" value="store"></input><p>Nhận tại cửa hàng</p>
                <input type="radio" id="receive-delivery" name="receive-method" value="delivery"></input><p>Giao tận nơi</p>
              </div>
              <div class="half-inputs">
