      ...
      <div className="tong">
        ...
        <div className="deals">
            <div className="coupon-box">
              ...
              <div class="coupon-code"><input name="discountcouponcode" id="discountcouponcode" placeholder="Mã giảm giá" type="text" class="discount-coupon-code" aria-label="Nhập mã phiếu giảm giá"> <button type="submit" name="applydiscountcouponcode" id="applydiscountcouponcode" class="button-2 apply-discount-coupon-code-button">Áp dụng</button></div>
              </div>
