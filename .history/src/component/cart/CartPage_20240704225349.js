                ...
                <div className="deals">
                  <div className="coupon-box">
                    ...
                    <div className="coupon-code">
                      <input name="discountcouponcode" id="discountcouponcode" placeholder="Mã giảm giá" type="text" className="discount-coupon-code discount" aria-label="Nhập mã phiếu giảm giá"/>
                      <button
                        type="submit"
