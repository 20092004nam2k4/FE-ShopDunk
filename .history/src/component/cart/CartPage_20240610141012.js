      ...
      <div className="cart-page">
        ...
        <div className="tong">
          <div className="left">
            ...
            <a href="http://localhost:8090/api/products">
          ...
          <div className="right">
            <div className="summary">
              <h2 className="order-summary">Tóm tắt đơn hàng</h2>
              <div className="price">
                <p className="left-price">Tạm tính</p>
                <p className="right-price">{calculateSubtotal().toLocaleString()}₫</p>
              </div>
              <div className="price">
                <p className="left-price">Phí giao hàng</p>
                <p className="right-price">0₫</p>
              </div>
              <div className="price">
              ...
              <div className="group">
                <label className="delivery">
                  <input
                    ...
                    value="delivery"
                  />
                  <span className="text">Giao hàng tận nơi</span>
                </label>
                <label className="pickup">
                  <input
                    ...
                    value="pickup"
                  />
                  <span className="text">Nhận tại cửa hàng</span>
                </label>
              </div>
