  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8090/api/users/login", // Update this URL to match your API endpoint
        credentials
      );
      if (response.data) {
        ...
        <section className="bg-dark" style={{ height: "243px" }}>
          <div className="container text-center text-md-start mt-5 textFooter">
            <div className="row mt-3 leftText">
              <div className="col-md-3 col-lg-4 col-xl-3 text-left mb-4">
                <h6
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 text-left mb-4">
                ...
                <p style={{ fontSize: "16px" }}>Ngọc Linh</p>
                <p style={{ fontSize: "16px" }}>Đinh Mạnh</p>
                <p style={{ fontSize: "16px" }}>Phương Nam</p>
              </div>
